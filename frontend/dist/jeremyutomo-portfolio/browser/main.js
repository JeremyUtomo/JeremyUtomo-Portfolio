...
function setNgReflectProperties(lView, element, type, dataValue, value) {
  if (type & (3 | 4)) {
    for (let i2 = 0; i2 < dataValue.length; i2 += 3) {
      setNgReflectProperty(lView, element, type, dataValue[i2 + 1], value);
    }
  }
}
...
function initializeDirectives(tView, lView, tNode, directives, exportsMap, hostDirectiveDefs) {
  ngDevMode && assertFirstCreatePass(tView);
  for (let i2 = 0; i2 < directives.length; i2++) {
    diPublicInInjector(getOrCreateNodeInjectorForNode(tNode, lView), tView, directives[i2].type);
  }
...
function setInputsFromAttrs(lView, directiveIndex, instance, def, tNode, initialInputData) {
  ...
  if (initialInputs !== null) {
    for (let i2 = 0; i2 < initialInputs.length; ) {
      const publicName = initialInputs[i2++];
      const privateName = initialInputs[i2++];
      const flags = initialInputs[i2++];
      const value = initialInputs[i2++];
    ...
    if (inputs.hasOwnProperty(attrName)) {
      ...
      for (let j = 0; j < inputConfig.length; j += 3) {
        if (inputConfig[j] === directiveIndex) {
          inputsToStore.push(attrName, inputConfig[j + 1], inputConfig[j + 2], attrs[i2 + 1]);
          break;
        }
      }
    }
...
function setInputsForProperty(tView, lView, inputs, publicName, value) {
  for (let i2 = 0; i2 < inputs.length; ) {
    const index = inputs[i2++];
    const privateName = inputs[i2++];
    const flags = inputs[i2++];
...
function createRootComponent(componentView, rootComponentDef, rootDirectives, hostDirectiveDefs, rootLView, hostFeatures) {
  ...
  for (let i2 = 0; i2 < rootDirectives.length; i2++) {
    const directiveIndex = rootTNode.directiveStart + i2;
...
var PendingTasks = class _PendingTasks {
  ...
  static {
    this.\u0275fac = function PendingTasks_Factory(t2) {
      return new (t2 || _PendingTasks)();
    };
  }
  static {
...
function interpolationV(lView, values) {
  ...
  for (let i2 = 1; i2 < values.length; i2 += 2) {
    content += renderStringify(values[i2]) + values[i2 + 1];
  }
  return content;
}
...
function \u0275\u0275attributeInterpolateV(attrName, values, sanitizer, namespace) {
  ...
  if (interpolated !== NO_CHANGE) {
    ...
    if (ngDevMode) {
      ...
      for (let i2 = 2; i2 < values.length; i2 += 2) {
        interpolationInBetween.push(values[i2]);
      }
...
var u = void 0;
function plural(val) {
  const n2 = val, i2 = Math.floor(Math.abs(val)), v = val.toString().replace(/^[^.]*\.?/, "").length;
  if (i2 === 1 && v === 0)
    return 1;
  return 5;
}
...
function applyUpdateOpCodes(tView, lView, updateOpCodes, bindingsStartIndex, changeMask2) {
  for (let i2 = 0; i2 < updateOpCodes.length; i2++) {
    ...
    if (checkBit & changeMask2) {
      let value = "";
      for (let j = i2 + 1; j <= i2 + skipCodes; j++) {
...
function findExistingListener(tView, lView, eventName, tNodeIdx) {
  ...
  if (tCleanup != null) {
    for (let i2 = 0; i2 < tCleanup.length - 1; i2 += 2) {
      ...
      if (cleanupEventName === eventName && tCleanup[i2 + 1] === tNodeIdx) {
        const lCleanup = lView[CLEANUP];
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
  ...
  if (processOutputs && outputs !== null && (props = outputs[eventName])) {
    ...
    if (propsLength) {
      for (let i2 = 0; i2 < propsLength; i2 += 2) {
        const index = props[i2];
        ngDevMode && assertIndexInRange(lView, index);
        const minifiedName = props[i2 + 1];
...
var Console = class _Console {
  ...
  static {
    this.\u0275fac = function Console_Factory(t2) {
      return new (t2 || _Console)();
    };
  }
  static {
...
var Testability = class _Testability {
  ...
  static {
    this.\u0275fac = function Testability_Factory(t2) {
      return new (t2 || _Testability)(\u0275\u0275inject(NgZone), \u0275\u0275inject(TestabilityRegistry), \u0275\u0275inject(TESTABILITY_GETTER));
    };
  }
  static {
...
var TestabilityRegistry = class _TestabilityRegistry {
  ...
  static {
    this.\u0275fac = function TestabilityRegistry_Factory(t2) {
      return new (t2 || _TestabilityRegistry)();
    };
  }
  static {
...
var ApplicationInitStatus = class _ApplicationInitStatus {
  ...
  static {
    this.\u0275fac = function ApplicationInitStatus_Factory(t2) {
      return new (t2 || _ApplicationInitStatus)();
    };
  }
  static {
...
var ApplicationRef = class _ApplicationRef {
  ...
  static {
    this.\u0275fac = function ApplicationRef_Factory(t2) {
      return new (t2 || _ApplicationRef)();
    };
  }
  static {
...
var Compiler = class _Compiler {
  ...
  static {
    this.\u0275fac = function Compiler_Factory(t2) {
      return new (t2 || _Compiler)();
    };
  }
  static {
...
var NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  ...
  static {
    this.\u0275fac = function NgZoneChangeDetectionScheduler_Factory(t2) {
      return new (t2 || _NgZoneChangeDetectionScheduler)();
    };
  }
  static {
...
var ZoneStablePendingTask = class _ZoneStablePendingTask {
  ...
  static {
    this.\u0275fac = function ZoneStablePendingTask_Factory(t2) {
      return new (t2 || _ZoneStablePendingTask)();
    };
  }
  static {
...
var PlatformRef = class _PlatformRef {
  ...
  static {
    this.\u0275fac = function PlatformRef_Factory(t2) {
      return new (t2 || _PlatformRef)(\u0275\u0275inject(Injector));
    };
  }
  static {
...
var ApplicationModule = class _ApplicationModule {
  ...
  static {
    this.\u0275fac = function ApplicationModule_Factory(t2) {
      return new (t2 || _ApplicationModule)(\u0275\u0275inject(ApplicationRef));
    };
  }
  static {
...
var ImagePerformanceWarning = class _ImagePerformanceWarning {
  ...
  static {
    this.\u0275fac = function ImagePerformanceWarning_Factory(t2) {
      return new (t2 || _ImagePerformanceWarning)();
    };
  }
  static {
...
var ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  ...
  static {
    this.\u0275fac = function ChangeDetectionSchedulerImpl_Factory(t2) {
      return new (t2 || _ChangeDetectionSchedulerImpl)();
    };
  }
  static {
...
var PlatformNavigation = class _PlatformNavigation {
  static {
    this.\u0275fac = function PlatformNavigation_Factory(t2) {
      return new (t2 || _PlatformNavigation)();
    };
  }
  static {
...
var PlatformLocation = class _PlatformLocation {
  ...
  static {
    this.\u0275fac = function PlatformLocation_Factory(t2) {
      return new (t2 || _PlatformLocation)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var BrowserPlatformLocation = class _BrowserPlatformLocation extends PlatformLocation {
  ...
  static {
    this.\u0275fac = function BrowserPlatformLocation_Factory(t2) {
      return new (t2 || _BrowserPlatformLocation)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var LocationStrategy = class _LocationStrategy {
  ...
  static {
    this.\u0275fac = function LocationStrategy_Factory(t2) {
      return new (t2 || _LocationStrategy)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var PathLocationStrategy = class _PathLocationStrategy extends LocationStrategy {
  ...
  static {
    this.\u0275fac = function PathLocationStrategy_Factory(t2) {
      return new (t2 || _PathLocationStrategy)(\u0275\u0275inject(PlatformLocation), \u0275\u0275inject(APP_BASE_HREF, 8));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var HashLocationStrategy = class _HashLocationStrategy extends LocationStrategy {
  ...
  static {
    this.\u0275fac = function HashLocationStrategy_Factory(t2) {
      return new (t2 || _HashLocationStrategy)(\u0275\u0275inject(PlatformLocation), \u0275\u0275inject(APP_BASE_HREF, 8));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var Location = class _Location {
  ...
  static {
    this.\u0275fac = function Location_Factory(t2) {
      return new (t2 || _Location)(\u0275\u0275inject(LocationStrategy));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function parseNumber(num) {
  ...
  if (i2 === (zeros = numStr.length)) {
    ...
    integerLen -= i2;
    digits = [];
    for (j = 0; i2 <= zeros; i2++, j++) {
      digits[j] = Number(numStr.charAt(i2));
    }
  }
...
var NgLocalization = class _NgLocalization {
  static {
    this.\u0275fac = function NgLocalization_Factory(t2) {
      return new (t2 || _NgLocalization)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
      token: _NgLocalization,
      factory: function NgLocalization_Factory(t2) {
        let r = null;
        if (t2) {
          r = new t2();
        } else {
...
var NgLocaleLocalization = class _NgLocaleLocalization extends NgLocalization {
  ...
  static {
    this.\u0275fac = function NgLocaleLocalization_Factory(t2) {
      return new (t2 || _NgLocaleLocalization)(\u0275\u0275inject(LOCALE_ID));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var NgClass = class _NgClass {
  ...
  static {
    this.\u0275fac = function NgClass_Factory(t2) {
      return new (t2 || _NgClass)(\u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(Renderer2));
    };
  }
  static {
...
var NgComponentOutlet = class _NgComponentOutlet {
  ...
  static {
    this.\u0275fac = function NgComponentOutlet_Factory(t2) {
      return new (t2 || _NgComponentOutlet)(\u0275\u0275directiveInject(ViewContainerRef));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgForOf = class _NgForOf {
  ...
  static {
    this.\u0275fac = function NgForOf_Factory(t2) {
      return new (t2 || _NgForOf)(\u0275\u0275directiveInject(ViewContainerRef), \u0275\u0275directiveInject(TemplateRef), \u0275\u0275directiveInject(IterableDiffers));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgIf = class _NgIf {
  ...
  static {
    this.\u0275fac = function NgIf_Factory(t2) {
      return new (t2 || _NgIf)(\u0275\u0275directiveInject(ViewContainerRef), \u0275\u0275directiveInject(TemplateRef));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgSwitch = class _NgSwitch {
  ...
  static {
    this.\u0275fac = function NgSwitch_Factory(t2) {
      return new (t2 || _NgSwitch)();
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgSwitchCase = class _NgSwitchCase {
  ...
  static {
    this.\u0275fac = function NgSwitchCase_Factory(t2) {
      return new (t2 || _NgSwitchCase)(\u0275\u0275directiveInject(ViewContainerRef), \u0275\u0275directiveInject(TemplateRef), \u0275\u0275directiveInject(NgSwitch, 9));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgSwitchDefault = class _NgSwitchDefault {
  ...
  static {
    this.\u0275fac = function NgSwitchDefault_Factory(t2) {
      return new (t2 || _NgSwitchDefault)(\u0275\u0275directiveInject(ViewContainerRef), \u0275\u0275directiveInject(TemplateRef), \u0275\u0275directiveInject(NgSwitch, 9));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgPlural = class _NgPlural {
  ...
  static {
    this.\u0275fac = function NgPlural_Factory(t2) {
      return new (t2 || _NgPlural)(\u0275\u0275directiveInject(NgLocalization));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgPluralCase = class _NgPluralCase {
  ...
  static {
    this.\u0275fac = function NgPluralCase_Factory(t2) {
      return new (t2 || _NgPluralCase)(\u0275\u0275injectAttribute("ngPluralCase"), \u0275\u0275directiveInject(TemplateRef), \u0275\u0275directiveInject(ViewContainerRef), \u0275\u0275directiveInject(NgPlural, 1));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgStyle = class _NgStyle {
  ...
  static {
    this.\u0275fac = function NgStyle_Factory(t2) {
      return new (t2 || _NgStyle)(\u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(KeyValueDiffers), \u0275\u0275directiveInject(Renderer2));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var NgTemplateOutlet = class _NgTemplateOutlet {
  ...
  static {
    this.\u0275fac = function NgTemplateOutlet_Factory(t2) {
      return new (t2 || _NgTemplateOutlet)(\u0275\u0275directiveInject(ViewContainerRef));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var AsyncPipe = class _AsyncPipe {
  ...
  static {
    this.\u0275fac = function AsyncPipe_Factory(t2) {
      return new (t2 || _AsyncPipe)(\u0275\u0275directiveInject(ChangeDetectorRef, 16));
    };
  }
  static {
...
var LowerCasePipe = class _LowerCasePipe {
  ...
  static {
    this.\u0275fac = function LowerCasePipe_Factory(t2) {
      return new (t2 || _LowerCasePipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var TitleCasePipe = class _TitleCasePipe {
  ...
  static {
    this.\u0275fac = function TitleCasePipe_Factory(t2) {
      return new (t2 || _TitleCasePipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var UpperCasePipe = class _UpperCasePipe {
  ...
  static {
    this.\u0275fac = function UpperCasePipe_Factory(t2) {
      return new (t2 || _UpperCasePipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var DatePipe = class _DatePipe {
  ...
  static {
    this.\u0275fac = function DatePipe_Factory(t2) {
      return new (t2 || _DatePipe)(\u0275\u0275directiveInject(LOCALE_ID, 16), \u0275\u0275directiveInject(DATE_PIPE_DEFAULT_TIMEZONE, 24), \u0275\u0275directiveInject(DATE_PIPE_DEFAULT_OPTIONS, 24));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var I18nPluralPipe = class _I18nPluralPipe {
  ...
  static {
    this.\u0275fac = function I18nPluralPipe_Factory(t2) {
      return new (t2 || _I18nPluralPipe)(\u0275\u0275directiveInject(NgLocalization, 16));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var I18nSelectPipe = class _I18nSelectPipe {
  ...
  static {
    this.\u0275fac = function I18nSelectPipe_Factory(t2) {
      return new (t2 || _I18nSelectPipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var JsonPipe = class _JsonPipe {
  ...
  static {
    this.\u0275fac = function JsonPipe_Factory(t2) {
      return new (t2 || _JsonPipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var KeyValuePipe = class _KeyValuePipe {
  ...
  static {
    this.\u0275fac = function KeyValuePipe_Factory(t2) {
      return new (t2 || _KeyValuePipe)(\u0275\u0275directiveInject(KeyValueDiffers, 16));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var DecimalPipe = class _DecimalPipe {
  ...
  static {
    this.\u0275fac = function DecimalPipe_Factory(t2) {
      return new (t2 || _DecimalPipe)(\u0275\u0275directiveInject(LOCALE_ID, 16));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var PercentPipe = class _PercentPipe {
  ...
  static {
    this.\u0275fac = function PercentPipe_Factory(t2) {
      return new (t2 || _PercentPipe)(\u0275\u0275directiveInject(LOCALE_ID, 16));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var CurrencyPipe = class _CurrencyPipe {
  ...
  static {
    this.\u0275fac = function CurrencyPipe_Factory(t2) {
      return new (t2 || _CurrencyPipe)(\u0275\u0275directiveInject(LOCALE_ID, 16), \u0275\u0275directiveInject(DEFAULT_CURRENCY_CODE, 16));
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var SlicePipe = class _SlicePipe {
  ...
  static {
    this.\u0275fac = function SlicePipe_Factory(t2) {
      return new (t2 || _SlicePipe)();
    };
  }
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
...
var CommonModule = class _CommonModule {
  static {
    this.\u0275fac = function CommonModule_Factory(t2) {
      return new (t2 || _CommonModule)();
    };
  }
  static {
...
var LCPImageObserver = class _LCPImageObserver {
  ...
  static {
    this.\u0275fac = function LCPImageObserver_Factory(t2) {
      return new (t2 || _LCPImageObserver)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var PreconnectLinkChecker = class _PreconnectLinkChecker {
  ...
  static {
    this.\u0275fac = function PreconnectLinkChecker_Factory(t2) {
      return new (t2 || _PreconnectLinkChecker)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var PreloadLinkCreator = class _PreloadLinkCreator {
  ...
  static {
    this.\u0275fac = function PreloadLinkCreator_Factory(t2) {
      return new (t2 || _PreloadLinkCreator)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var NgOptimizedImage = class _NgOptimizedImage {
  ...
  static {
    this.\u0275fac = function NgOptimizedImage_Factory(t2) {
      return new (t2 || _NgOptimizedImage)();
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var BrowserXhr = class _BrowserXhr {
  ...
  static {
    this.\u0275fac = function BrowserXhr_Factory(t2) {
      return new (t2 || _BrowserXhr)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var EventManager = class _EventManager {
  ...
  static {
    this.\u0275fac = function EventManager_Factory(t2) {
      return new (t2 || _EventManager)(\u0275\u0275inject(EVENT_MANAGER_PLUGINS), \u0275\u0275inject(NgZone));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var SharedStylesHost = class _SharedStylesHost {
  ...
  static {
    this.\u0275fac = function SharedStylesHost_Factory(t2) {
      return new (t2 || _SharedStylesHost)(\u0275\u0275inject(DOCUMENT2), \u0275\u0275inject(APP_ID), \u0275\u0275inject(CSP_NONCE, 8), \u0275\u0275inject(PLATFORM_ID));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var DomRendererFactory2 = class _DomRendererFactory2 {
  ...
  static {
    this.\u0275fac = function DomRendererFactory2_Factory(t2) {
      return new (t2 || _DomRendererFactory2)(\u0275\u0275inject(EventManager), \u0275\u0275inject(SharedStylesHost), \u0275\u0275inject(APP_ID), \u0275\u0275inject(REMOVE_STYLES_ON_COMPONENT_DESTROY), \u0275\u0275inject(DOCUMENT2), \u0275\u0275inject(PLATFORM_ID), \u0275\u0275inject(NgZone), \u0275\u0275inject(CSP_NONCE));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var DomEventsPlugin = class _DomEventsPlugin extends EventManagerPlugin {
  ...
  static {
    this.\u0275fac = function DomEventsPlugin_Factory(t2) {
      return new (t2 || _DomEventsPlugin)(\u0275\u0275inject(DOCUMENT2));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var KeyEventsPlugin = class _KeyEventsPlugin extends EventManagerPlugin {
  ...
  static {
    this.\u0275fac = function KeyEventsPlugin_Factory(t2) {
      return new (t2 || _KeyEventsPlugin)(\u0275\u0275inject(DOCUMENT2));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var BrowserModule = class _BrowserModule {
  ...
  static {
    this.\u0275fac = function BrowserModule_Factory(t2) {
      return new (t2 || _BrowserModule)(\u0275\u0275inject(BROWSER_MODULE_PROVIDERS_MARKER, 12));
    };
  }
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
...
var Meta = class _Meta {
  ...
  static {
    this.\u0275fac = function Meta_Factory(t2) {
      return new (t2 || _Meta)(\u0275\u0275inject(DOCUMENT2));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var Title = class _Title {
  ...
  static {
    this.\u0275fac = function Title_Factory(t2) {
      return new (t2 || _Title)(\u0275\u0275inject(DOCUMENT2));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var HammerGestureConfig = class _HammerGestureConfig {
  ...
  static {
    this.\u0275fac = function HammerGestureConfig_Factory(t2) {
      return new (t2 || _HammerGestureConfig)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var HammerGesturesPlugin = class _HammerGesturesPlugin extends EventManagerPlugin {
  ...
  static {
    this.\u0275fac = function HammerGesturesPlugin_Factory(t2) {
      return new (t2 || _HammerGesturesPlugin)(\u0275\u0275inject(DOCUMENT2), \u0275\u0275inject(HAMMER_GESTURE_CONFIG), \u0275\u0275inject(Console), \u0275\u0275inject(HAMMER_LOADER, 8));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var HammerModule = class _HammerModule {
  static {
    this.\u0275fac = function HammerModule_Factory(t2) {
      return new (t2 || _HammerModule)();
    };
  }
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
...
var DomSanitizer = class _DomSanitizer {
  static {
    this.\u0275fac = function DomSanitizer_Factory(t2) {
      return new (t2 || _DomSanitizer)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
      token: _DomSanitizer,
      factory: function DomSanitizer_Factory(t2) {
        let r = null;
        if (t2) {
          r = new (t2 || _DomSanitizer)();
        } else {
...
var DomSanitizerImpl = class _DomSanitizerImpl extends DomSanitizer {
  ...
  static {
    this.\u0275fac = function DomSanitizerImpl_Factory(t2) {
      return new (t2 || _DomSanitizerImpl)(\u0275\u0275inject(DOCUMENT2));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function HeaderComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_15_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_15_Template_a_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleMobileMenu());
    });
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_15_Template_a_click_5_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleMobileMenu());
    });
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_15_Template_a_click_7_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleMobileMenu());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classMap(ctx_r1.isActive("about") ? "text-primary font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r1.isActive("stack") ? "text-primary font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r1.isActive("projects") ? "text-primary font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
  }
}
var HeaderComponent = class _HeaderComponent {
  ...
  static {
    this.\u0275fac = function HeaderComponent_Factory(t2) {
      return new (t2 || _HeaderComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 9, consts: [[1, "bg-surface/90", "backdrop-blur-sm", "shadow-sm", "sticky", "top-0", "w-full", "z-50", "flex", "justify-between", "items-center", "px-margin-mobile", "md:px-margin-desktop", "py-4", "max-w-container-max", "mx-auto"], [1, "font-headline-md", "text-headline-md", "font-bold", "text-primary"], [1, "hidden", "md:flex", "gap-gutter", "items-center"], ["href", "#about"], ["href", "#stack"], ["href", "#projects"], ["href", "#contact"], [1, "md:hidden", "text-on-surface", "flex", "items-center", 3, "click"], [1, "material-symbols-outlined"], [1, "md:hidden", "bg-surface", "shadow-md", "flex", "flex-col", "gap-4", "px-margin-mobile", "py-6", "sticky", "top-[72px]", "z-40"], ["href", "#about", 3, "click"], ["href", "#stack", 3, "click"], ["href", "#projects", 3, "click"], ["href", "#contact", 1, "text-on-surface-variant", "hover:text-primary", "transition-colors", "font-label-sm", "text-label-sm", 3, "click"]], template: function HeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "header", 0)(1, "div", 1);
        \u0275\u0275text(2, " Jeremy Utomo ");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(14, "menu");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(15, HeaderComponent_Conditional_15_Template, 9, 6, "div", 9);
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        \u0275\u0275classMap(ctx.isActive("about") ? "text-primary border-b-2 border-primary pb-1 font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
        \u0275\u0275advance(2);
        \u0275\u0275classMap(ctx.isActive("stack") ? "text-primary border-b-2 border-primary pb-1 font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
        \u0275\u0275advance(2);
        \u0275\u0275classMap(ctx.isActive("projects") ? "text-primary border-b-2 border-primary pb-1 font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
        \u0275\u0275advance(2);
        \u0275\u0275classMap(ctx.isActive("contact") ? "text-primary border-b-2 border-primary pb-1 font-label-sm text-label-sm" : "text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm");
        \u0275\u0275advance(5);
        \u0275\u0275conditional(15, ctx.mobileMenuOpen ? 15 : -1);
      }
    }, encapsulation: 2 });
  }
};
...
function t() {
  return t = Object.assign ? Object.assign.bind() : function(t2) {
    for (var s2 = 1; s2 < arguments.length; s2++) {
      var e2 = arguments[s2];
      for (var n2 in e2)
        ({}).hasOwnProperty.call(e2, n2) && (t2[n2] = e2[n2]);
    }
    return t2;
  }, t.apply(null, arguments);
}
var s = { strings: ["These are the default values...", "You know what you should do?", "Use your own!", "Have a great day!"], stringsElement: null, typeSpeed: 0, startDelay: 0, backSpeed: 0, smartBackspace: true, shuffle: false, backDelay: 700, shouldBackspace: true, fadeOut: false, fadeOutClass: "typed-fade-out", fadeOutDelay: 500, loop: false, loopCount: Infinity, showCursor: true, cursorChar: "|", autoInsertCss: true, attr: null, bindInputFocusEvents: false, contentType: "html", onBegin: function(t2) {
...
var e = new (/* @__PURE__ */ function() {
  ...
  return n2.load = function(e3, n3, i2) {
    ...
    for (var u2 in e3.strPos = 0, e3.currentElContent = this.getCurrentElContent(e3), e3.currentElContent && e3.currentElContent.length > 0 && (e3.strPos = e3.currentElContent.length - 1, e3.strings.unshift(e3.currentElContent)), e3.sequence = [], e3.strings)
      e3.sequence[u2] = u2;
...
var i = /* @__PURE__ */ function() {
  ...
  return s2.toggle = function() {
  ...
  }, s2.append = function(t3) {
    var s3 = this, e2 = this.strings[this.strings.length - 1];
    this.strings.push(t3), this.sequence = this.strings.map(function(t4, s4) {
      return s4;
    }), this.typingComplete && (this.timeout = this.shouldBackspace ? setTimeout(function() {
      s3.backspace(e2, e2.length - 1);
    }, this.backDelay) : setTimeout(function() {
      s3.arrayPos++, s3.typewrite(s3.strings[s3.sequence[s3.arrayPos]], 0);
    }, this.backDelay));
  }, s2.begin = function() {
    var t3 = this;
    this.options.onBegin(this), this.typingComplete = false, this.shuffleStringsIfNeeded(), this.insertCursor(), this.bindInputFocusEvents && this.bindFocusEvents(), this.timeout = setTimeout(function() {
    ...
    true !== this.pause.status ? this.timeout = setTimeout(function() {
      ...
      if ("`" === o.charAt(0)) {
        for (; "`" !== t3.substring(s3 + r).charAt(0) && (r++, !(s3 + r > t3.length)); )
          ;
        var u2 = t3.substring(0, s3), c = t3.substring(u2.length + 1, s3 + r), p = t3.substring(s3 + r + 1);
        t3 = u2 + c + p, r--;
      }
    ...
    if (0 === s3 && (this.toggleBlinking(false), this.options.preStringTyped(this.arrayPos, this)), this.shouldBackspace) {
      var n2 = t3.substring(0, s3 += e2);
      this.replaceText(n2);
    } else {
      var i2 = t3.substring(s3, s3 + e2);
      s3 += e2, this.replaceText(i2);
    }
    this.typewrite(t3, s3);
  }, s2.doneTyping = function(t3, s3) {
    var e2 = this;
    this.options.onStringTyped(this.arrayPos, this), this.toggleBlinking(true), this.isFinalString() && (this.complete(), false === this.loop || this.curLoop === this.loopCount) || (this.timeout = this.shouldBackspace ? setTimeout(function() {
      e2.backspace(t3, s3);
    }, this.backDelay) : setTimeout(function() {
      e2.arrayPos++, e2.typewrite(e2.strings[e2.sequence[e2.arrayPos]], 0);
    }, this.backDelay));
    ...
    if (true !== this.pause.status) {
      ...
      this.timeout = setTimeout(function() {
        ...
        if (e2.replaceText(i3), e2.smartBackspace) {
          var r = e2.strings[e2.sequence[e2.arrayPos + 1]];
          e2.stopNum = r && i3 === r.substring(0, s3) ? s3 : 0;
        }
        s3 > e2.stopNum ? (s3--, e2.backspace(t3, s3)) : s3 <= e2.stopNum && (e2.isFinalString() ? e2.lastStringBackspaced() : (e2.arrayPos++, e2.typewrite(e2.strings[e2.sequence[e2.arrayPos]], s3)));
      }, i2);
    } else
      this.setPauseStatus(t3, s3, false);
  }, s2.isFinalString = function() {
    return this.arrayPos === this.strings.length - 1;
  }, s2.lastStringBackspaced = function() {
    ...
    this.attr ? this.el.setAttribute(this.attr, t3) : this.isInput ? this.el.value = t3 : "html" === this.contentType ? this.shouldBackspace ? this.el.innerHTML = t3 : this.el.innerHTML += t3 : this.el.textContent = t3;
...
var _c0 = ["typedTarget"];
var TerminalComponent = class _TerminalComponent {
  ngAfterViewInit() {
    this.typed = new i(this.typedTarget.nativeElement, {
      strings: [
...
<span class="text-green-400 font-semibold">\u2714 deployment successful. Hello, World!</span>`
  ...
  static {
    this.\u0275fac = function TerminalComponent_Factory(t2) {
      return new (t2 || _TerminalComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TerminalComponent, selectors: [["app-terminal"]], viewQuery: function TerminalComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.typedTarget = _t.first);
      }
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 10, vars: 0, consts: [["typedTarget", ""], [1, "w-full", "rounded-xl", "overflow-hidden", "shadow-[0_8px_40px_rgba(0,0,0,0.35)]", "font-mono", "text-sm", 2, "background", "#0d1117"], [1, "flex", "items-center", "gap-2", "px-4", "py-3", "border-b", "border-white/10", 2, "background", "#161b22"], [1, "w-3", "h-3", "rounded-full", "bg-[#ff5f57]", "inline-block"], [1, "w-3", "h-3", "rounded-full", "bg-[#febc2e]", "inline-block"], [1, "w-3", "h-3", "rounded-full", "bg-[#28c840]", "inline-block"], [1, "ml-4", "text-xs", "text-white/40", "tracking-wide", "select-none"], [1, "terminal-body", "p-5", "leading-7", "text-gray-300", "overflow-x-auto"]], template: function TerminalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2);
        \u0275\u0275element(2, "span", 3)(3, "span", 4)(4, "span", 5);
        \u0275\u0275elementStart(5, "span", 6);
        \u0275\u0275text(6, " jeremy@portfolio:~ ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(7, "div", 7);
        \u0275\u0275element(8, "span", null, 0);
        \u0275\u0275elementEnd()();
      }
    }, styles: ["\n\n.terminal-body[_ngcontent-%COMP%] {\n  min-height: 220px;\n}\n.typed-cursor[_ngcontent-%COMP%] {\n  color: #4ade80;\n  font-weight: 100;\n}\n/*# sourceMappingURL=terminal.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TerminalComponent, { className: "TerminalComponent" });
})();

// src/app/components/hero/hero.component.ts
var HeroComponent = class _HeroComponent {
  static {
    this.\u0275fac = function HeroComponent_Factory(t2) {
      return new (t2 || _HeroComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeroComponent, selectors: [["app-hero"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 0, consts: [[1, "max-w-container-max", "mx-auto", "px-margin-mobile", "md:px-margin-desktop", "py-20", "md:py-32", "grid", "md:grid-cols-2", "gap-gutter", "items-center"], [1, "flex", "flex-col", "gap-6"], [1, "flex", "flex-col", "gap-2"], [1, "font-label-sm", "text-label-sm", "text-secondary", "uppercase", "tracking-widest"], [1, "font-display-lg-mobile", "text-display-lg-mobile", "md:font-display-lg", "md:text-display-lg", "text-primary"], [1, "font-body-lg", "text-body-lg", "text-on-surface-variant", "max-w-lg"], [1, "flex", "gap-4", "mt-4"], ["href", "#projects", 1, "bg-primary", "text-on-primary", "font-label-sm", "text-label-sm", "px-8", "py-3", "rounded", "hover:opacity-90", "transition-opacity", "text-center"], ["href", "#contact", 1, "border", "border-primary", "text-primary", "font-label-sm", "text-label-sm", "px-8", "py-3", "rounded", "hover:bg-surface-container", "transition-colors", "text-center"], [1, "flex", "items-center", "justify-center"]], template: function HeroComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
        \u0275\u0275text(4, " Junior Cloud & Software Engineer ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "h1", 4);
        \u0275\u0275text(6, " Engineering smart applications and scalable cloud infrastructure. ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(7, "p", 5);
        \u0275\u0275text(8, " From programming autonomous robots to designing CI/CD pipelines. A curious and team-oriented problem solver, eager to build and automate in the cloud. ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "div", 6)(10, "a", 7);
        \u0275\u0275text(11, " View Projects ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "a", 8);
        \u0275\u0275text(13, " Contact Me ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(14, "div", 9);
        \u0275\u0275element(15, "app-terminal");
        \u0275\u0275elementEnd()();
      }
    }, dependencies: [TerminalComponent], encapsulation: 2 });
  }
};
(() => {
...
var AboutComponent = class _AboutComponent {
  static {
    this.\u0275fac = function AboutComponent_Factory(t2) {
      return new (t2 || _AboutComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AboutComponent, selectors: [["app-about"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 10, vars: 0, consts: [["id", "about", 1, "bg-surface-container-lowest", "py-20", "md:py-32"], [1, "max-w-container-max", "mx-auto", "px-margin-mobile", "md:px-margin-desktop", "grid", "md:grid-cols-12", "gap-gutter"], [1, "md:col-span-4"], [1, "font-headline-md", "text-headline-md", "text-primary", "mb-6"], [1, "md:col-span-8", "flex", "flex-col", "gap-6"], [1, "font-body-lg", "text-body-lg", "text-on-surface"], [1, "font-body-md", "text-body-md", "text-on-surface-variant"]], template: function AboutComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
        \u0275\u0275text(4, " About Me ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(5, "div", 4)(6, "p", 5);
        \u0275\u0275text(7, " I am a soon-to-be Software Engineering graduate with a strong foundation in full-stack development and an eagerness to dive deep into cloud technologies. My engineering journey is driven by fundamental curiosity: whether I am building a web platform for trauma therapy or programming an autonomous humanoid robot using C# and Python, I love breaking down complex problems and building reliable solutions. ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(8, "p", 6);
        \u0275\u0275text(9, " Recently, my focus has shifted heavily toward cloud architecture and deployment automation. Having hands-on experience with AWS integrations, Kubernetes, and setting up CI/CD pipelines, I am passionate about infrastructure and continuous learning. I thrive in collaborative, Agile teams where knowledge sharing is key. I am an assertive communicator who isn't afraid to make mistakes, as long as they lead to better, automated, and scalable results. ");
        \u0275\u0275elementEnd()()()();
      }
    }, encapsulation: 2 });
  }
...
function StackComponent_For_15_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275styleMap("--bar-width:" + skill_r1.level + "%");
  }
}
function StackComponent_For_24_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tag_r2.name, " ");
  }
}
function StackComponent_For_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 12)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275styleMap("--bar-width:" + skill_r3.level + "%");
  }
}
var StackComponent = class _StackComponent {
  constructor(el) {
    this.el = el;
    this.languages = [
      { name: "Java", level: 90 },
  ...
  static {
    this.\u0275fac = function StackComponent_Factory(t2) {
      return new (t2 || _StackComponent)(\u0275\u0275directiveInject(ElementRef));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StackComponent, selectors: [["app-stack"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 34, vars: 0, consts: [["id", "stack", 1, "max-w-container-max", "mx-auto", "px-margin-mobile", "md:px-margin-desktop", "py-20", "md:py-32"], [1, "text-center", "mb-16"], [1, "font-headline-md", "text-headline-md", "text-primary", "mb-4"], [1, "font-body-md", "text-body-md", "text-on-surface-variant", "max-w-2xl", "mx-auto"], [1, "grid", "md:grid-cols-3", "gap-8"], [1, "bg-surface-container-lowest", "rounded-xl", "p-8", "shadow-[0_4px_20px_rgba(26,54,93,0.05)]", "hover:shadow-[0_8px_30px_rgba(26,54,93,0.1)]", "transition-shadow", "border", "border-transparent", "hover:border-secondary"], [1, "flex", "items-center", "gap-3", "mb-6"], [1, "material-symbols-outlined", "text-secondary", "text-2xl"], [1, "font-label-sm", "text-label-sm", "uppercase", "tracking-widest", "text-primary"], [1, "flex", "flex-col", "gap-4"], [1, "flex", "flex-wrap", "gap-2"], [1, "px-3", "py-1", "bg-secondary/10", "text-secondary", "font-label-sm", "text-label-sm", "rounded-full"], [1, "flex", "justify-between", "font-label-sm", "text-label-sm", "mb-1", "text-on-surface"], [1, "h-1.5", "w-full", "bg-surface-container", "rounded-full", "overflow-hidden"], [1, "bar-fill", "h-full", "bg-gradient-to-r", "from-primary", "to-secondary", "rounded-full"]], template: function StackComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
        \u0275\u0275text(3, " Technical Proficiency ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "p", 3);
        \u0275\u0275text(5, " Core competencies across software development, cloud architecture, and robotics. ");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275repeaterCreate(14, StackComponent_For_15_Template, 6, 3, "div", null, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(16, "div", 5)(17, "div", 6)(18, "span", 7);
        \u0275\u0275text(19, "cloud");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(20, "h3", 8);
        \u0275\u0275text(21, " Cloud & DevOps ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(22, "div", 10);
        \u0275\u0275repeaterCreate(23, StackComponent_For_24_Template, 2, 1, "span", 11, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(25, "div", 5)(26, "div", 6)(27, "span", 7);
        \u0275\u0275text(28, "database");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "h3", 8);
        \u0275\u0275text(30, " Web, Mobile & Databases ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "div", 9);
        \u0275\u0275repeaterCreate(32, StackComponent_For_33_Template, 6, 3, "div", null, _forTrack0);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
        ...
        \u0275\u0275advance(9);
        \u0275\u0275repeater(ctx.cloudTags);
        \u0275\u0275advance(9);
        \u0275\u0275repeater(ctx.webAndDb);
      }
    }, styles: ["\n\n.bar-fill[_ngcontent-%COMP%] {\n  width: 0%;\n  transition: width 1s cubic-bezier(0.4, 0, 0.2, 1);\n}\n.bar-fill.animate[_ngcontent-%COMP%] {\n  width: var(--bar-width);\n}\n/*# sourceMappingURL=stack.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StackComponent, { className: "StackComponent" });
})();

// src/app/components/projects/projects.component.ts
var _forTrack02 = ($index, $item) => $item.title;
function ProjectsComponent_For_22_Template(rf, ctx) {
  if (rf & 1) {
...
function ProjectsComponent_For_25_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ProjectsComponent_For_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(9, ProjectsComponent_For_25_For_10_Template, 2, 1, "span", 22, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const project_r3 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", project_r3.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", project_r3.role, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", project_r3.description, " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(project_r3.tags);
  }
}
var ProjectsComponent = class _ProjectsComponent {
    ...
    this.projects = [
      {
        ...
        description: "Integrated AWS S3 buckets into an existing full-stack application for scalable storage. Conducted hands-on research on Kubernetes (K8s) container orchestration and successfully implemented CI/CD pipelines to integrate external repositories within a complex multi-repo architecture.",
      ...
      },
      {
        ...
        description: "Developed a mobile application to control and interface with the Unitree G1 humanoid robot. Handled complex system communications and real-time data processing using .NET Blazor and Python within a ROS2 environment.",
        tags: [".NET Blazor", "Python", "ROS2"]
      },
      {
        title: "Internship: MedTech App with CI/CD & Automated Testing",
        role: "Frontend & DevOps Developer",
        description: "Frontend application development for connecting to a Continuous Glucose Monitor via Bluetooth (BLE). Built a custom native Flutter plugin and set up a robust CI/CD pipeline for automated unit testing to ensure high-quality, reliable code.",
        tags: ["Flutter", "Swift", "Kotlin", "CI/CD"]
      },
      {
        title: "Robotics Minor: Autonomous Object Manipulation",
        role: "Robotics Software Engineer",
        description: "Programmed a Unitree G1 humanoid robot to operate autonomously. Engineered the logic for the robot to independently detect, pick up, transport, and place objects (bottles), demonstrating strong problem-solving skills in complex environments.",
        tags: ["Python", "ROS2"]
      },
      {
        title: "Full-Stack Trauma Therapy Platform (SPINE NGO)",
        role: "Full Stack Developer",
        description: "Built a full-stack web application to digitize a paper-based trauma therapy method. Engineered a secure backend login system, automated email services, and comprehensive code testing (Agile/Scrum), enabling therapists to guide multiple clients efficiently and remotely.",
  ...
  static {
    this.\u0275fac = function ProjectsComponent_Factory(t2) {
      return new (t2 || _ProjectsComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProjectsComponent, selectors: [["app-projects"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 26, vars: 3, consts: [["id", "projects", 1, "bg-surface-container-lowest", "py-20", "md:py-32"], [1, "max-w-container-max", "mx-auto", "px-margin-mobile", "md:px-margin-desktop"], [1, "font-headline-md", "text-headline-md", "text-primary", "mb-4"], [1, "font-body-md", "text-body-md", "text-on-surface-variant", "mb-12"], [1, "bg-primary", "rounded-xl", "overflow-hidden", "shadow-[0_8px_32px_rgba(26,54,93,0.18)]", "flex", "flex-col", "md:flex-row", "mb-8", "border", "border-secondary", "group"], [1, "hidden", "md:block", "w-1.5", "bg-secondary", "flex-shrink-0", "rounded-l-xl"], [1, "p-8", "md:p-10", "flex", "flex-col", "flex-grow"], [1, "flex", "items-center", "gap-3", "mb-3"], [1, "material-symbols-outlined", "text-secondary-fixed", "text-xl"], [1, "font-label-sm", "text-label-sm", "text-secondary-fixed", "uppercase", "tracking-widest"], [1, "font-display-lg-mobile", "text-display-lg-mobile", "text-on-primary", "mb-2"], [1, "font-label-sm", "text-label-sm", "text-secondary-fixed-dim", "mb-4"], [1, "font-body-lg", "text-body-lg", "text-on-primary/80", "mb-8", "max-w-3xl"], [1, "flex", "flex-wrap", "gap-2", "mt-auto"], [1, "px-3", "py-1", "bg-secondary", "text-on-secondary", "font-label-sm", "text-label-sm", "rounded-full"], [1, "grid", "md:grid-cols-2", "gap-8"], [1, "bg-surface", "rounded-xl", "overflow-hidden", "shadow-[0_4px_20px_rgba(26,54,93,0.05)]", "flex", "flex-col", "group", "border", "border-transparent", "hover:border-secondary", "transition-all"], [1, "p-8", "flex-grow"], [1, "font-headline-md", "text-headline-md", "text-primary", "mb-2"], [1, "font-label-sm", "text-label-sm", "text-secondary", "mb-4"], [1, "font-body-md", "text-body-md", "text-on-surface-variant"], [1, "bg-surface-container", "p-6", "flex", "flex-wrap", "gap-2", "border-t", "border-surface-container-highest"], [1, "px-3", "py-1", "bg-secondary/10", "text-secondary", "font-label-sm", "text-label-sm", "rounded-full"]], template: function ProjectsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
        \u0275\u0275text(3, " Projects & Experience ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "p", 3);
        \u0275\u0275text(5, " Hands-on work across cloud infrastructure, DevOps, robotics, and full-stack development. ");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275repeaterCreate(21, ProjectsComponent_For_22_Template, 2, 1, "span", 14, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(23, "div", 15);
        \u0275\u0275repeaterCreate(24, ProjectsComponent_For_25_Template, 11, 3, "div", 16, _forTrack02);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(15);
        \u0275\u0275textInterpolate1(" ", ctx.featuredProject.title, " ");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", ctx.featuredProject.role, " ");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", ctx.featuredProject.description, " ");
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.featuredProject.tags);
        \u0275\u0275advance(3);
        \u0275\u0275repeater(ctx.regularProjects);
      }
    }, encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProjectsComponent, { className: "ProjectsComponent" });
})();

// src/app/components/footer/footer.component.ts
var FooterComponent = class _FooterComponent {
  static {
    this.\u0275fac = function FooterComponent_Factory(t2) {
      return new (t2 || _FooterComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 0, consts: [["id", "contact", 1, "bg-surface-container-low", "w-full", "py-20", "px-margin-mobile", "md:px-margin-desktop", "flex", "flex-col", "md:flex-row", "justify-between", "items-center", "gap-gutter", "max-w-container-max", "mx-auto", "border-t", "border-surface-container-highest"], [1, "text-center", "md:text-left"], [1, "font-headline-md", "text-headline-md", "font-bold", "text-on-surface", "mb-2"], [1, "font-body-md", "text-body-md", "text-on-surface-variant"], [1, "flex", "gap-6", "items-center"], ["href", "https://www.linkedin.com/in/jeremy-utomo-234506252/", "target", "_blank", "rel", "noopener noreferrer", 1, "text-on-surface-variant", "hover:text-primary", "transition-opacity", "hover:opacity-80", "font-label-sm", "text-label-sm"], ["href", "https://github.com/JeremyUtomo", "target", "_blank", "rel", "noopener noreferrer", 1, "text-on-surface-variant", "hover:text-primary", "transition-opacity", "hover:opacity-80", "font-label-sm", "text-label-sm"], ["href", "mailto:hujeremy@icloud.com", 1, "text-on-surface-variant", "hover:text-primary", "transition-opacity", "hover:opacity-80", "font-label-sm", "text-label-sm"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "footer", 0)(1, "div", 1)(2, "div", 2);
        \u0275\u0275text(3, " Jeremy Utomo ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "p", 3);
        \u0275\u0275text(5, " \xA9 2026 Jeremy Utomo. Engineered for Reliability. ");
        \u0275\u0275elementEnd()();
...
var AppComponent = class _AppComponent {
  static {
    this.\u0275fac = function AppComponent_Factory(t2) {
      return new (t2 || _AppComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 0, template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "app-header")(1, "app-hero")(2, "app-about")(3, "app-stack")(4, "app-projects")(5, "app-footer");
      }
    }, dependencies: [
      HeaderComponent,
      HeroComponent,
